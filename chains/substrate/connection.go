...
func (c *Connection) Connect() error {
	...
	c.api = api
	c.log.Info("Init new NewSubstrateAPI Done", "api", api)
	...
	c.log.Info("Get genesisHash Done", "genesisHash", genesisHash)
...
func (c *Connection) checkChainId(expected msg.ChainId) error {
	...
	// c.log.Info("=== Connecting to substrate chain...", "actual", actual)

	// c.log.Info("=== Connecting to substrate chain...", "BridgePalletName", utils.BridgePalletName)

	// c.log.Info("=== Connecting to substrate chain...", "err", err)
